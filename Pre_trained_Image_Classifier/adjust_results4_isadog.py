...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile,"r") as file_dogname:
        # Reads in dognames from first line in file
        line = file_dogname.readline()
        # Processes each line in file until reaching EOF (end-of-file) by 
        # processing line and adding dognames to dognames_dic with while loop
        for line in file_dogname:
    ...
    for key in results_dic:
        ...
        # Pet Image Label IS of Dog (e.g. found in dict_dogname)
        if results_dic[key][0] in dict_dogname:
            
            # Classifier Label IS image of Dog (e.g. found in dict_dogname)
            # appends (1, 1) because both labels are dogs
            if results_dic[key][1] in dict_dogname:
            ...
            #                              
            # Classifier Label IS NOT image of dog (e.g. NOT in dict_dogname)
            # appends (1,0) because only pet label is a dog
            else:
                results_dic[key].extend((1, 0))

        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dict_dogname)
        else:
...
#     result = adjust_results4_isadog(results_dic, file_dogname)
#     print(result)
